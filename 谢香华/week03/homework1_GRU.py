...
class CharGRUDataset(Dataset):
    def __init__(self,texts,number_labels,char_to_index,max_len):
        self.texts=texts
        self.number_labels=torch.tensor(number_labels,dtype=torch.long)
    ...
    def __getitem__(self,idx):
        ...
        return torch.tensor(indices,dtype=torch.long),self.number_labels[idx]
...
gru_dataset=CharGRUDataset(texts,number_labels,char_to_index,max_len)
